...
**Phase L2: mockups-legacy Molecules** — Exec ⬜ (three sub-phases L2a/L2b/L2c)
...
Next: start L2a — extract the ~18 molecules from `frontend/src/features/` that have direct counterparts in `docs/mockups/molecules/` (cards / modals / toast / banner / navs / FAB / filters / sheets / drawers / forms / list-items). After L2a ✅, queue L2b (~40-60 frontend-specific) and L2c (specialized long-tail). After L5 ✅ ships, Current Phase advances to **Phase 5: Auth + onboarding + consent**.
