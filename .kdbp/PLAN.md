...
Phase 1: Limiter infra + statement stopgap

## Deferred (explicit)

Scale-tier rows 11-16 of the ranked table (push-token cap, group-hygiene caps, rectification/notification caps, read limits, scan burst cap, Redis storage) — deferred by user direction 2026-06-12; P86 tracks them.
