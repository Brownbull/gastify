 ...
 * every "pick one of a small set" control.
 *
 * VENDORED from design-lab/src/design-system/atoms/SegmentedToggle.tsx — kept
 * verbatim. We vendor (copy under web/src) instead of importing the external
 * design-lab path because @tailwindcss/vite's DEV scanner only generates classes
 * found in files under the Vite root; classes unique to the external design-lab
 * file (e.g. px-gt-14) never get emitted in dev, collapsing the control. Keep in
 * sync with the design-lab source.
 *
