 ...
 * from design-lab (DM-13) in W7. Produces rectangles with aspect ratios near 1
 * (squares) so areas are easy to compare. Output coordinates are 0–100
 * PERCENTAGE units. Pure logic, no React, no deps.
 *
...
/**
 * Step-function container height by visible category count: keeps the treemap
 * from jumping on every expand/collapse.
 */
