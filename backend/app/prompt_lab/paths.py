...
STATEMENT_TEST_CASES_ROOT = PROMPT_TESTING_ROOT / "test-cases" / "statements"
STATEMENT_PRIVATE_ROOT = STATEMENT_TEST_CASES_ROOT / "private"
...
STATEMENT_MANIFEST_PATH = STATEMENT_TEST_CASES_ROOT / "manifest.json"
