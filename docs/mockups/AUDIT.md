...
| Desktop Web (1440 responsive) | 🚧 **11/29 shipped** (Dashboard + History + Tx Editor + Settings + Trends + Insights + Reports + Ítems + 3 Scan) — shared shell CSS extracted, 18 to apply |
