#!/usr/bin/env node
/**
 * check-token-classes — Phase-10 smoke gate.
 *
 * Scans every `gt-*` utility class used in design-lab source and verifies the
 * suffix exists in the matching `@theme` namespace of the generated tokens.css.
