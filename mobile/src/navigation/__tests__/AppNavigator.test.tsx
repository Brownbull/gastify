...
jest.mock("../../screens/ItemsScreen", () => ({
  ItemsScreen: () => {
    const { Text } = require("react-native");
    return <Text testID="items-screen">Items</Text>;
  },
}));
...
jest.mock("../../screens/ReportsScreen", () => ({
  ReportsScreen: () => {
    const { Text } = require("react-native");
    return <Text testID="reports-screen">Reports</Text>;
  },
}));
...
jest.mock("../../screens/NotificationsScreen", () => ({
  NotificationsScreen: () => {
    const { Text } = require("react-native");
    return <Text testID="notifications-screen">Notifications</Text>;
  },
}));
...
jest.mock("../../screens/ReportDetailScreen", () => ({
  ReportDetailScreen: () => {
    const { Text } = require("react-native");
    return <Text testID="report-detail-screen">ReportDetail</Text>;
  },
}));
